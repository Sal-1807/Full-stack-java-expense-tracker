...
public class LoginView {
    ...
    private Label signUpLabel = new Label("Don't have an account yet? Click Here");
    ...
    private Scene createScene() {
        ...
        return new Scene(mainContainerBox, Utilitie.APP_WIDTH = 1350 , Utilitie.APP_HEIGHT = 700);
    }
    ...
    private VBox createLoginFormBox(){
        ...
        loginButton.getStyleClass().addAll("text-size-lg", "bg-light-blue", "text-white", "text-width-700", "rounded-border");
