...
//                resizeTableWidthColumns();
    ...
    private HBox createBalanceSummaryBox(){
        ...
        totalIncomeLabel.getStyleClass().addAll("text-size-lg", "text-white");
        ...
        totalExpenseLabel.getStyleClass().addAll("text-size-lg", "text-white");
    ...
    private GridPane createContentGridPane(){
        ...
        recentTransactionsVBox.getStyleClass().addAll("field-background2", "rounded-border", "padding-10px");
    ...
    private HBox createYearComboBoxAndChartButtonBox(){
        ...
        yearComboBox.getStyleClass().addAll("field-background2","text-size-md");
        yearComboBox.setValue(Year.now().getValue()); // defaults to the current year

        viewChartButton = new Button("View Chart");
        viewChartButton.getStyleClass().addAll("field-background2", "text-light-gray", "text-size-md");
    ...
    private VBox createTransactionsTableContentBox(){
        ...
        monthColumn.getStyleClass().addAll("field-background", "text-size-md", "text-light-gray2");

        incomeColumn = new TableColumn<>("Income");
        incomeColumn.setCellValueFactory(new PropertyValueFactory<>("income"));
        incomeColumn.getStyleClass().addAll("field-background", "text-size-md", "text-light-gray2");

        expenseColumn = new TableColumn<>("Expense");
        expenseColumn.setCellValueFactory(new PropertyValueFactory<>("expense"));
        expenseColumn.getStyleClass().addAll("field-background", "text-size-md", "text-light-gray2");
    ...
    private VBox createRecentTransactionsVBox(){
        ...
        addTransactionButton.getStyleClass().addAll("field-background2", "text-size-md", "text-light-gray", "rounded-border");
