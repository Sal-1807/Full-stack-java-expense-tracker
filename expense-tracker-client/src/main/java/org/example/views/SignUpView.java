...
public class SignUpView {
    ...
    private Scene createScene(){
        ...
        return new Scene(mainContainer, Utilitie.APP_HEIGHT = 1350 , Utilitie.APP_WIDTH = 750 );
    }
    ...
    private VBox createSignUpForm(){
        ...
        rePasswordField.setPromptText("Re-enter your password");
        rePasswordField.setMaxWidth(473);

        registerButton.getStyleClass().addAll("test-size-lg", "bg-light-blue", "text-white", "text-weight-700", "rounded-border" );
